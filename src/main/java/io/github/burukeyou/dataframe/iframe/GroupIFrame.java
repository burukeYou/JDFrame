...
public interface GroupIFrame<T> {
     ...
     */
    <K,V> IFrame<FI2<K,String>> groupByConcat(Function<T, K> key, Function<T,V> concatField,CharSequence delimiter);
     ...
     */
    <K> IFrame<FI2<K,String>> groupByConcat(Function<T, K> key, GroupConcat<T> concat);
     ...
     * @param delimiter                    concat delimiter
     */
    <K,J,V> IFrame<FI3<K,J,String>> group2ByConcat(Function<T, K> key, Function<T, J> key2, Function<T,V> concatField,CharSequence delimiter);
     ...
     * @param concat                       group concat builder
     */
    <K,J> IFrame<FI3<K,J,String>> group2ByConcat(Function<T, K> key, Function<T, J> key2,GroupConcat<T> concat);
     ...
     * @param concat                       group concat builder
     */
    <K,J,H> IFrame<FI4<K,J,H,String>> group3ByConcat(Function<T, K> key, Function<T, J> key2,Function<T, H> key3,GroupConcat<T> concat);
