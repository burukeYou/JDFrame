...
public class JDFrameImpl<T> extends AbstractDataFrameImpl<T> implements JDFrame<T> {
    ...
    /*    else {
        ...
        if (!dataList.isEmpty()){
            if (dataList.get(0) != null){
                ...
                dataList.stream().filter(Objects::nonNull).findFirst().ifPresent(e -> fieldClass = e.getClass());
            }
        }
    }
    ...
    @Override
    public JDFrame<T> forEachNextDo(ConsumerNext<? super T> action) {
    ...
    @Override
    public <K, J> JDFrameImpl<FI3<K, J, List<T>>> group2(Function<T, K> key, Function<T, J> key2) {
        return returnDF(groupListKey(key,key2));
    }

    @Override
    public <K, J, V> JDFrameImpl<FI3<K, J, V>> group2ByCustom(Function<T, K> key, Function<T, J> key2, ListToOneValueFunction<T, V> function) {
        return returnDF(groupListKey(key,key2,function));
    }
    @Override
    public <K, J, H> JDFrameImpl<FI4<K, J, H, List<T>>> group3(Function<T, K> key, Function<T, J> key2, Function<T, H> key3) {
        return returnDF(groupListKey(key,key2,key3));
    }

    @Override
    public <K, J, H, V> JDFrameImpl<FI4<K, J, H, V>> group3ByCustom(Function<T, K> key, Function<T, J> key2, Function<T, H> key3, ListToOneValueFunction<T, V> function) {
    ...
    @Override
    public <K, J,R extends Number> JDFrameImpl<FI3<K, J, BigDecimal>> group2BySum(Function<T, K> key,
                                                                                  Function<T, J> key2,
                                                                                  NumberFunction<T,R> value) {
        Collector<T, ?, BigDecimal> tBigDecimalCollector = CollectorsPlusUtil.summingBigDecimalForNumber(value);
    ...
    @Override
    public <K, J, H,R extends Number> JDFrameImpl<FI4<K, J, H, BigDecimal>> group3BySum(Function<T, K> key,
                                                                                        Function<T, J> key2,
                                                                                        Function<T, H> key3,
                                                                                        NumberFunction<T,R> value) {
        Collector<T, ?, BigDecimal> tBigDecimalCollector = CollectorsPlusUtil.summingBigDecimalForNumber(value);
    ...
    @Override
    public <K, J> JDFrameImpl<FI3<K, J, Long>> group2ByCount(Function<T, K> key,
                                                             Function<T, J> key2) {
        Collector<Object, ?, Long> counting = counting();
    ...
    @Override
    public <K, J, H> JDFrameImpl<FI4<K, J, H, Long>> group3ByCount(Function<T, K> key,
                                                                   Function<T, J> key2,
                                                                   Function<T, H> key3) {
        Collector<Object, ?, Long> counting = counting();
    ...
    @Override
    public <K, J,R extends Number> JDFrameImpl<FI4<K, J, BigDecimal, Long>> group2BySumCount(Function<T, K> key,
                                                                                             Function<T, J> key2,
                                                                                             NumberFunction<T,R> value) {
        List<T> dataList = viewList();
        Collector<T, ?, BigDecimal> tBigDecimalCollector = CollectorsPlusUtil.summingBigDecimalForNumber(value);
        List<FI3<K, J, BigDecimal>> sumList = returnDF(dataList).groupKey(key, key2, tBigDecimalCollector);
        List<FI3<K, J, Long>> countList =  from(dataList).group2ByCount(key, key2).viewList();
        // 合并sum和count字段
    ...
    @Override
    public <K, J,R extends Number> JDFrameImpl<FI3<K, J, BigDecimal>> group2ByAvg(Function<T, K> key,
                                                                                  Function<T, J> key2,
                                                                                  NumberFunction<T,R> value) {
    ...
    @Override
    public <K, J, H,R extends Number> JDFrameImpl<FI4<K, J, H, BigDecimal>> group3ByAvg(Function<T, K> key,
                                                                                        Function<T, J> key2,
                                                                                        Function<T, H> key3,
                                                                                        NumberFunction<T,R> value) {
        Collector<T, ?, BigDecimal> tBigDecimalCollector = CollectorsPlusUtil.averagingBigDecimal(value, defaultScale, getOldRoundingMode());
    ...
    @Override
    public <K,J, V extends Comparable<? super V>> JDFrameImpl<FI3<K,J,T>> group2ByMax(Function<T, K> key, Function<T, J> key2, Function<T, V> value) {
    ...
    @Override
    public <K, J, V extends Comparable<? super V>> JDFrameImpl<FI3<K, J, V>> group2ByMaxValue(Function<T, K> key, Function<T, J> key2, Function<T, V> value) {
        return group2ByMax(key, key2,value).map(e -> new FI3<>(e.getC1(),e.getC2(),getApplyValue(value,e.getC3())));
    }
    ...
    @Override
    public <K, J, V extends Comparable<? super V>> JDFrameImpl<FI3<K, J, T>> group2ByMin(Function<T, K> key, Function<T, J> key2, Function<T, V> value) {
    ...
    @Override
    public <K, J, V extends Comparable<? super V>> JDFrameImpl<FI3<K, J, V>> group2ByMinValue(Function<T, K> key, Function<T, J> key2, Function<T, V> value) {
        return  this.group2ByMin(key, key2,value).map(e -> new FI3<>(e.getC1(),e.getC2(),getApplyValue(value,e.getC3())));
    }
    ...
    @Override
    public <K, J, V extends Comparable<? super V>> JDFrameImpl<FI3<K, J, MaxMin<V>>> group2ByMaxMinValue(Function<T, K> key,
                                                                                                         Function<T, J> key2,
                                                                                                         Function<T, V> value) {
    ...
    @Override
    public <K, J, V extends Comparable<? super V>> JDFrameImpl<FI3<K, J, MaxMin<T>>> group2ByMaxMin(Function<T, K> key,
                                                                                                    Function<T, J> key2,
                                                                                                    Function<T, V> value) {
    ...
    @Override
    public <K, V> JDFrameImpl<FI2<K, String>> groupByConcat(Function<T, K> key, Function<T, V> concatField, CharSequence delimiter) {
        return returnDF(groupByConcatStream(key,GroupConcat.concatBy(concatField,delimiter)));
    }

    @Override
    public <K> JDFrameImpl<FI2<K, String>> groupByConcat(Function<T, K> key, GroupConcat<T> concat) {
        return returnDF(groupByConcatStream(key,concat));
    }

    @Override
    public <K, J, V> JDFrameImpl<FI3<K, J, String>> group2ByConcat(Function<T, K> key, Function<T, J> key2, Function<T, V> concatField, CharSequence delimiter) {
        return returnDF(groupByConcatStream(key,key2,GroupConcat.concatBy(concatField,delimiter)));
    }

    @Override
    public <K, J> JDFrameImpl<FI3<K, J, String>> group2ByConcat(Function<T, K> key, Function<T, J> key2, GroupConcat<T> concat) {
        return returnDF(groupByConcatStream(key,key2,concat));
    }

    @Override
    public <K, J, H> JDFrameImpl<FI4<K, J, H, String>> group3ByConcat(Function<T, K> key, Function<T, J> key2, Function<T, H> key3, GroupConcat<T> concat) {
