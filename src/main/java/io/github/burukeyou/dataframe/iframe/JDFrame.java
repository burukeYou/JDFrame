...
public interface JDFrame<T> extends ConfigurableJDFrame<T> {
     ...
     */
    JDFrame<T> forEachPreDo(ConsumerPrevious<? super T> action);
     ...
     */
    <G, C> JDFrame<T> replenishGroup(Function<T, G> groupDim,
     ...
     * @param <C>        type of collection within the group
     */
    <G, C> JDFrame<T> replenishGroup(Function<T, G> groupDim, Function<T, C> collectDim, ReplenishFunction<G,C,T> getEmptyObject);
